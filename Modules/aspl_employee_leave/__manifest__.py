...
##############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            '/aspl_employee_leave/static/src/js/employee_leave_hierarchy.js',
            '/aspl_employee_leave/static/src/css/main.css',
            '/aspl_employee_leave/static/src/xml/employee_leave_hierarchy.xml',
            ],
    },
    'license': 'LGPL-3',
    'installable': True,
