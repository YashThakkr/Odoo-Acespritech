    ...
    def web_login(self, redirect=None, **kw):
        ...
        if request.httprequest.method == 'POST':
            ...
            try:
                ...
                if user.has_group('aspl_direct_checkin_ee.group_direct_checkin'):
                    ...
                    if employee_id:
                        ...
                        if attendance_id:
                            if attendance_id.check_out:
                                ...
                                return request.render('aspl_direct_checkin_ee.checkin_template', values)
                        else:
                            values.update({'login': 'in', 'employee_name': employee_id.name, 'employee_id':employee_id.id})
                            return request.render('aspl_direct_checkin_ee.checkin_template', values)
        ...
        if user.has_group('aspl_direct_checkin_ee.group_direct_checkin'):
            ...
            if employee_id:
                ...
                if attendance_id:
                    ...
                    return request.render('aspl_direct_checkin_ee.checkin_template',
                                          values)
        try:
