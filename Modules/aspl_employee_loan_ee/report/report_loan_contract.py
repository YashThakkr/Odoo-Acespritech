...
class WrappedReportLoanContract(models.AbstractModel):
    _name = 'report.aspl_employee_loan_ee.report_loan_contract'
    _description = 'report.aspl_employee_loan_ee.report_loan_contract'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report = report_obj._get_report_from_name('aspl_employee_loan_ee.report_loan_contract')
        docargs = {
            'doc_ids': docids,
