...
PERIOD = [('01', 'January'), ('02', 'February'), ('03', 'March'), ('04', 'April'), ('05', 'May'), ('06', 'June'), ('07', 'July'),
          ('08', 'August'), ('09', 'September'), ('10', 'October'), ('11', 'November'), ('12', 'December')]


class summary_wiz(models.Model):
    _name = 'summary.wiz'
    ...
    def summary_details(self):
        ...
        return self.env['ir.actions.report']._get_report_from_name('aspl_hr_advance_salary_ee.template_hr_adv_sal').report_action(self, data=datas)
