...
#################################################################################
{
    'name': 'Odoo CyberSource Payment Gateway (Community)',
    ...
    'assets': {
        'web.assets_frontend_lazy': [
            'aspl_payment_cybersource/static/src/js/payment_form.js',
            'aspl_payment_cybersource/static/src/css/style.css',
        ],
    },
}
