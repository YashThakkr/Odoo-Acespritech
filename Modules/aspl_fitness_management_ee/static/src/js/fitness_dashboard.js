odoo.define('aspl_fitness_management_ee.fitness_dashboard', function (require) {
"use strict";
...
var FitnessDashboard = AbstractAction.extend({
    ...
    render_dashboard: async function() {
        ...
        var multi_branch = await ajax.jsonRpc('/check_multi_branch', 'call', {
            ...
            args: ['aspl_fitness_management_ee.group_multi_branches'],
        });
        if (multi_branch){
...
//  Total Members
    ...
    total_members: function(e) {
        ...
        this.do_action('aspl_fitness_management_ee.action_subscriber')
    },
...
//  Membership History
    ...
    membership_history: function(e) {
        ...
        this.do_action('aspl_fitness_management_ee.action_subscriber_membership_history')
    },
...
//  subscriber plan
    ...
    subscriber_plan: async function(e) {
        ...
        this.do_action('aspl_fitness_management_ee.action_subscriber_gym_plan')
    },
...
//  services
    ...
    service: function(e) {
        ...
        this.do_action('aspl_fitness_management_ee.action_service_product')
    },
...
//  To expire plan
    ...
    payment_button: async function(e) {
        ...
        // var ir_view_id = await self._rpc({
        //         model: 'ir.ui.view',
        //         method: '_get_view_id',
        //         args: ['account.view_account_payment_register_form'],
        //     })  
        this.do_action({
