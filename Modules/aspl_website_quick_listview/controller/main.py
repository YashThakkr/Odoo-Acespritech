...
class WebsiteSale(WebsiteSale):
    ...
    def get_product_list(self, search_string='', **post):
        product_ids = request.env['product.product'].search(['|', ('name', 'ilike', str(search_string)),
    ...
    @http.route(['/get-currency-symbol'], type='json', auth="public", website=True)
    def get_symbol_currency(self, **post):
