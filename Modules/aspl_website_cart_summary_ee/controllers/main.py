...
class CartSummary(http.Controller):
    ...
    def cart_summary(self, **kw):
        ...
        return {'data': request.env['ir.ui.view']._render_template("aspl_website_cart_summary_ee.website_cart_summary")}
...
class WebsiteCartSummary(WebsiteSale):
    ...
    def cart_update_json(
        ...
        values['cart_summary'] = request.env['ir.ui.view']._render_template(
            "aspl_website_cart_summary_ee.website_cart_summary", {
                'website_sale_order': order,
            })
        return values
