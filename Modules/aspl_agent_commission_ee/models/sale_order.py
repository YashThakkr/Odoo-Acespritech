...
class SaleOrder(models.Model):
    ...
    def _commission_calculation(self):
        return self.env['ir.config_parameter'].sudo(). \
                   get_param('aspl_agent_commission_ee.commission_calculation') or ''

    def commission_based(self):
        return self.env['ir.config_parameter'].sudo(). \
                   get_param('aspl_agent_commission_ee.commission_based_on') or ''
    ...
    def _compute_order_line(self):
        ...
        for rec in self:
            ...
            tax = rec.env['ir.config_parameter'].sudo() \
                .get_param('aspl_agent_commission_ee.commission_with')
            is_eligible = rec.env['ir.config_parameter'] \
                .sudo().get_param('aspl_agent_commission_ee.is_eligible')
            skip_order = int(rec.env['ir.config_parameter']
                             .sudo().get_param('aspl_agent_commission_ee.skip_order'))
