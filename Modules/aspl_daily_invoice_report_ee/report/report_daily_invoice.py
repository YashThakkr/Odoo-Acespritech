...
class ReportDailyInvoice(models.AbstractModel):
    _name = 'report.aspl_daily_invoice_report_ee.report_daily_invoice'
    _description = "Report Daily Invoice Template"

    @api.model
    def _get_report_values(self, docids, data=None):
        report_obj = self.env['ir.actions.report']
        report = report_obj._get_report_from_name('aspl_daily_invoice_report_ee.report_daily_invoice')
        docargs = {
