...
class LeaveEncashReport(models.AbstractModel):
    _name = 'report.aspl_leave_encash.leave_encash_report'
    _description = 'Report Aspl_leave_encash Leave_Encash_Report For Print Report'

    @api.model
    def _get_report_values(self, docids, data=None):
        report = self.env['ir.actions.report']._get_report_from_name('aspl_leave_encash.leave_encash_report')
        return {
