...
class WebsiteSale(WebsiteSale):
    ...
    def fast_order(self, **post):
        ...
        default_qty = int(param_obj.sudo().get_param('aspl_website_fast_order.fast_order_qty'))
        if post.get('text'):
        ...
        return request.render('aspl_website_fast_order.fast_order', {'product_dict': product_dict})
