...
class EmployeeTravelReqest(models.Model):
    ...
    def action_send_manager(self):
        ...
        if mail_address:
            try:
                template_id = self.env['ir.model.data'].get_object_reference('aspl_hr_travel_management',
    ...
    def action_reject(self):
        view_id = self.env.ref("aspl_hr_travel_management.aspl_reason_reject_wizard")
        return {
