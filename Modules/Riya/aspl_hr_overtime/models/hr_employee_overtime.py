...
class HrEmployeeOvertime(models.Model):
    ...
    def action_overtime_calculate(self, res):
        ...
        message = ""
        date = ""
        if self.env.user.has_group('aspl_hr_overtime.group_overtime_manual_overtime'):
            if res.line_ids:
    ...
    def generate_employee_overtime(self):
        ...
        for employee in self.env['hr.employee'].search([]):
            ...
            if not self.env.user.has_group('aspl_hr_overtime.group_overtime_manual_overtime'):
