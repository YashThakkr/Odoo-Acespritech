...
class AttendanceReportPdf(models.AbstractModel):
    _name = 'report.aspl_hr_attendance_report_ee.attendance_report_pdf'
    _description = 'Generates attendance report for employees based on Employee or Department'

    @api.model
    def _get_report_values(self, docids, data=None):
        report = self.env['ir.actions.report']._get_report_from_name('aspl_hr_attendance_report_ee.attendance_report_pdf')
        return {
