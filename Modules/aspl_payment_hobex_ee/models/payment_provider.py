...
class Paymentprovider(models.Model):
    ...
    def _get_default_payment_method_id(self,code):
        ...
        if self.code == 'hobex_credit_card':
            return self.env.ref('aspl_payment_hobex_ee.payment_method_hobex_credit_card').id
        elif self.code == 'hobex_paypal':
            return self.env.ref('aspl_payment_hobex_ee.payment_method_hobex_paypal').id
        elif self.code == 'hobex_sofort':
            return self.env.ref('aspl_payment_hobex_ee.payment_method_hobex_sofort').id
        else:
